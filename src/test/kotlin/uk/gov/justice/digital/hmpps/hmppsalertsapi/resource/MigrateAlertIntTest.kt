...
class MigrateAlertIntTest : IntegrationTestBase() {
  ...
  fun `400 bad request - no body`() {
    ...
    with(response!!) {
      ...
      assertThat(developerMessage).isEqualTo("Required request body is missing: public uk.gov.justice.digital.hmpps.hmppsalertsapi.model.Alert uk.gov.justice.digital.hmpps.hmppsalertsapi.resource.MigrateAlertsController.migrateAlert(uk.gov.justice.digital.hmpps.hmppsalertsapi.model.request.MigrateAlertRequest)")
